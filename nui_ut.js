...
ut.eases = {
    ...
    // Bounce
    'easeInBounce': (t, b, c, d) => c - ut.eases.easeOutBounce(d-t, 0, c, d) + b,
    ...
    'easeInOutBounce': (t, b, c, d) => {
        if (t < d/2) return ut.eases.easeInBounce(t*2, 0, c, d) * .5 + b;
        return ut.eases.easeOutBounce(t*2-d, 0, c, d) * .5 + c*.5 + b;
    }
};
